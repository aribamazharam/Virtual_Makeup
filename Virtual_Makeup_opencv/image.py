...
colors_map = {
    ...
    "LIP_UPPER": [0, 255, 0],  # Red in BGR
    "LIP_LOWER": [0, 255, 0],  # Red in BGR
    # eyeliner
    "EYELINER_LEFT": [0, 255, 0],  # Dark Blue in BGR
    "EYELINER_RIGHT": [0, 255, 0],  # Dark Blue in BGR
    # eye shadow
    "EYESHADOW_LEFT": [0, 255, 0],  # Dark Green in BGR
    "EYESHADOW_RIGHT": [0, 255, 0],  # Dark Green in BGR
    # eye brow
    "EYEBROW_LEFT": [0, 255, 0],  # Dark Brown in BGR
    "EYEBROW_RIGHT": [0, 255, 0],  # Dark Brown in BGR
}
